...
config.font_rules = {
    {
      intensity = 'Bold',
      italic = false,
      font = wezterm.font('SauceCodePro Nerd Font', { weight = 'ExtraBold' })
    },
    {
      intensity = 'Normal',
      italic = true,
      font = wezterm.font('SauceCodePro Nerd Font', { weight = 'DemiBold', style = 'Italic' })
    },
    {
      intensity = 'Bold',
      italic = true,
      font = wezterm.font('SauceCodePro Nerd Font', { weight = 'ExtraBold', style = 'Italic' })
    }
}
...
--
-- problems with all of the above with some TUIs (namely bluetuith)
--  this color scheem works pretty well with bluetuith and jjui
config.color_scheme = 'Catppuccin Latte (Gogh)'
