...
in
{
  ...
  environment.etc."kanshi/config" = {
    text = ''
      ...
      profile xps17_desk {
        output "Sharp Corporation 0x1517 Unknown" mode 3840x2400 position 2123,0 scale 2.00
        output "LG Electronics LG HDR 4K 406NTZNA2149" mode 3840x2160 position 2133,0 scale 1.00
