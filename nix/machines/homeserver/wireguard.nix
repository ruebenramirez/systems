      ...
      peers = [
        {
          ...
          allowedIPs = [
            "10.100.0.0/24"     # normal wgnet subnet
            "10.75.40.234/32"   # rueben phone mullvad vpn ip
            "10.71.234.205/32"  # Monica phone mullvad vpn ip
            "10.65.96.166/32"   # Monica laptop mullvad vpn ip
          ];
