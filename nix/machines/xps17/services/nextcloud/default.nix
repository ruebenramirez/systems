...

{
  ...
  services.postgresql = {
    ...
    dataDir = "/tank/srv/nextcloud/postgresql";
  ...
  services.redis.servers.nextcloud = {
    ...
    bind = "127.0.0.1";
    settings = {
      dir = pkgs.lib.mkForce "/tank/srv/nextcloud/redis";
  ...
  services.postgresqlBackup = {
    enable = true;
    databases = [ "nextcloud" ];
    location = "/tank/srv/nextcloud/backups/postgresql";
  };
  ...
  systemd.tmpfiles.rules = [
    ...
    "d /tank/srv/nextcloud/postgresql 0750 postgres postgres -"
    "d /tank/srv/nextcloud/redis 0750 redis redis -"
    "d /tank/srv/nextcloud/backups 0755 root root -"
    "d /tank/srv/nextcloud/backups/postgresql 0750 postgres postgres -"
    "d /tank/srv/nextcloud/backups/data 0750 nextcloud nextcloud -"
  ];
}
